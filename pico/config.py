...
# │  GND                 →  GND   (any GND pin)                          │
# │                                                                       │
# │  Bare EC11 (5 pins): CLK, DT, SW share a common GND; no VCC needed. │
# │  Breakout board with VCC pin: connect VCC/+ to 3.3 V.               │
# └──────────────────────────────────────────────────────────────────────┘
# Internal pull-ups are enabled; CLK, DT, and SW idle HIGH.
